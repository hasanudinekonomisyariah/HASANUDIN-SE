...
export const FileDownIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M12 18v-6" /><path d="m15 15-3 3-3-3" />
  </svg>
);
...
export const FingerprintIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2a9.33 9.33 0 0 0-4.42 1.42"/>
      <path d="M12 22a9.33 9.33 0 0 0 4.42-1.42"/>
      <path d="M2 12a10.68 10.68 0 0 1 .5-3.26"/>
      <path d="M22 12a10.68 10.68 0 0 0-.5-3.26"/>
      <path d="M5.2 4.2a15.75 15.75 0 0 0-2.7 3.51"/>
      <path d="M18.8 4.2a15.75 15.75 0 0 1 2.7 3.51"/>
      <path d="M4.2 18.8a15.75 15.75 0 0 0 3.51 2.7"/>
      <path d="M19.8 16.29a15.75 15.75 0 0 1-2.7 3.51"/>
      <path d="M7.71 6.29a11.37 11.37 0 0 0-2.26 2.26"/>
      <path d="M16.29 17.71a11.37 11.37 0 0 0 2.26-2.26"/>
